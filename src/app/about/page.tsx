...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Anyone with an invite. Sign in with Google — no password to remember. Your profile can have a photo, name, handle, and a public-sharing setting that is off until you turn it on.",
    icon: LockKeyhole,
  },
  {
